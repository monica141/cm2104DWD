 ...
 */
 $(document).ready(function () {
  ...
  var output="<table><thead><tr><th>Rover</th><th>Camera</th><th>Image URL</th><th>Earth date</th><th>Launch date</th></thead><tbody>";
  for (var i in photos)
  {
    output+="<tr><td>" + photos[i].rover.name + "</td><td>"
    + photos[i].camera.full_name + "</td><td>"
    + "<img src='" + photos[i].img_src +"' alt='photo'>" +"</td><td>"
